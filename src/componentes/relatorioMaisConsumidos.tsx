...
export default class RelatorioMaisConsumidos extends Component<Props> {
    render() {
        ...
        const produtosMaisConsumidos = listaProdutos.sort((a, b) => b.quantidade - a.quantidade).slice(0, 10);
        ...
        const servicosMaisConsumidos = listaServicos.sort((a, b) => b.quantidade - a.quantidade).slice(0, 10);
