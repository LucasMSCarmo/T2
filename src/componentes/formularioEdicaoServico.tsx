...
export default class FormularioEdicaoServico extends Component<Props, State> {
    constructor(props: Props) {
        super(props);
        this.state = {
            preco: props.servico.preco.toString(),
            tipo: props.servico.tipo,
        };
    ...
    handleSubmit(e: React.FormEvent) {
        ...
        this.props.onSalvar(servicoAtualizado);
    }

    render() {
        const { tema, onCancelar, servico } = this.props;
        return (
